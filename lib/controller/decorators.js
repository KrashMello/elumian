...
const Get = (path, withMiddelware = true) => {
    ...
    return (target, propertyKey) => {
        ...
        if (routes.filter((r) => r.handlerName === propertyKey).length ===
            ...
            routes[index] = Object.assign(Object.assign({}, routes[index]), { method: 'get', path,
                withMiddelware, handlerName: propertyKey });
        }
...
const Post = (path, withMiddelware = true) => {
    ...
    return (target, propertyKey) => {
        ...
        if (routes.filter((r) => r.handlerName === propertyKey).length ===
            ...
            routes[index] = Object.assign(Object.assign({}, routes[index]), { method: 'post', path,
                withMiddelware, handlerName: propertyKey });
        }
        Reflect.defineMetadata('routes', routes, target.constructor);
    };
...
const Put = (path, withMiddelware = true) => {
    ...
    return (target, propertyKey) => {
        ...
        if (routes.filter((r) => r.handlerName === propertyKey).length ===
            ...
            routes[index] = Object.assign(Object.assign({}, routes[index]), { method: 'put', path,
                withMiddelware, handlerName: propertyKey });
        }
        Reflect.defineMetadata('routes', routes, target.constructor);
    };
...
const Path = (path, withMiddelware = true) => {
    ...
    return (target, propertyKey) => {
        ...
        if (routes.filter((r) => r.handlerName === propertyKey).length ===
            ...
            routes[index] = Object.assign(Object.assign({}, routes[index]), { method: 'path', path,
                withMiddelware, handlerName: propertyKey });
        }
        Reflect.defineMetadata('routes', routes, target.constructor);
    };
...
const Delete = (path, withMiddelware = true) => {
    ...
    return (target, propertyKey) => {
        ...
        if (routes.filter((r) => r.handlerName === propertyKey).length ===
            ...
            routes[index] = Object.assign(Object.assign({}, routes[index]), { method: 'delete', path,
                withMiddelware, handlerName: propertyKey });
        }
        Reflect.defineMetadata('routes', routes, target.constructor);
    };
