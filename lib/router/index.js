...
const index_1 = __importDefault(require("../middelware/index"));
...
const infoSocket = [];
const socketRouter = [];
function router(controllers, app, io, Middelware = index_1.default) {
    controllers.forEach((Controller) => {
        ...
        routes.forEach(({ method, path, withMiddelware, handlerName, requestValidator }) => {
            ...
            info.push({
                api: `${method.toLocaleUpperCase()} http://${IPV4}:${(_a = process.env.SERVER_PORT) !== null && _a !== void 0 ? _a : 3000}${prefix.concat('', path)}`,
